...
document.addEventListener("DOMContentLoaded", function () {
	(function knightParallax(){
		...
		var speedValues = [0.2, 0.3, 0,4];
	

		for (var i = 0; i < $balls.length; i++){
			parallax($balls[i], $wrapper, speedValues[i], 1);
		}
	})()

	(function levitateBalls(){
		var $balls = document.querySelectorAll('.js-levitate-ball');
		var speedValues = [0.2, 0.4];
